...
const responseSchema = {
  ...
  properties: {
    score: {
      type: Type.NUMBER,
      description:
        "An overall work-life balance score from 0 to 100, where 100 is perfect balance.",
    },
    summary: {
      type: Type.STRING,
      description:
        "A 2-3 sentence summary of the user's work-life balance status, written in an encouraging and helpful tone.",
    },
    dimensionalScores: {
      type: Type.ARRAY,
      items: {
